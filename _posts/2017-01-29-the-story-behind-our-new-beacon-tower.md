...
{% include media/post-image.html filename="beacon-feature.jpg" thumb="beacon-feature-500x500.jpg" caption="Restored beacon tower" className="alignright" %}
...
{% include media/post-image.html filename="standard-beacon-installation.jpg" thumb="standard-beacon-installation-255x300.jpg" caption="Standard DoC installation" className="alignright" %}
...
{% include media/gallery.html gallery_id="gallery2" class="2by2" %}

{% include media/post-image.html filename="ideco-plate.jpg" thumb="ideco-plate-300x130.jpg" caption="IDECO Builders Plate" className="alignright" %}
...
{% include media/gallery.html gallery_id="gallery3" class="3by3" %}
...
{% include media/gallery.html gallery_id="gallery4" class="2by2" %}
...
{% include media/gallery.html gallery_id="gallery5" %}
