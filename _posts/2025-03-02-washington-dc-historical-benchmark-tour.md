...
{% include media/youtube.html embed_code="jYAMqNfMt-w" %}

{% include maps/geodata-map.html type="geojson" map_id="1" zoom="14" height="700px" file="washington-bms.geojson" icon_color="blue" %}
